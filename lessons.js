const lessons = [
  {
    ...
    ageGroup: "Ages 8–12",
    description: "A gentle lesson inspired by Sri Ramakrishna’s childhood.",
    sections: [
      {
        heading: "Why Are We Here?",
        keyIdea: "We are here to love God, who lives within us.",
        content:
          "We learn, grow, study, and work so that we can live well. But saints remind us that life becomes truly meaningful when we remember God, help others, and grow in love."
      },
      {
        heading: "Thinking About God",
        keyIdea: "The more we remember God, the deeper our love grows.",
        content:
          "Our saints and scriptures advise us to meditate on the Divine every day. This can be difficult because we cannot see God with our physical eyes, but we can feel God through love, prayer, and goodness."
      },
      {
        heading: "Choosing a Beloved Form of God",
        keyIdea: "A chosen deity helps the mind focus with love.",
        content:
          "Sri Ramakrishna taught that we may love all names and forms of God, while choosing one form that feels especially close to our heart. Sri Ram inspires compassion and patience. Hanumanji inspires courage, strength, and service."
      },
      {
        heading: "Young Gadadhar’s Joyful Devotion",
        keyIdea: "Learning about God can be joyful and creative.",
        content:
          "As a young boy, Sri Ramakrishna was known as Gadadhar. He loved listening to stories of Sri Ram and Sri Krishna. He and his friends acted out these stories in a mango grove."
      }
    ],
    glossary: [
      {
        term: "Sri Ramakrishna",
        pronunciation: "Shree Ra-ma-krish-na",
        meaning: "A great saint revered by many as an incarnation of God."
      },
      {
        term: "Gadadhar",
        pronunciation: "Ga-daa-dhar",
        meaning: "Sri Ramakrishna’s childhood name."
      },
      {
        term: "Ishta Devata",
        pronunciation: "Ish-ta De-va-taa",
        meaning: "A chosen form of God loved deeply by a devotee."
      }
    ],
    quiz: [
      {
        ...
        correct: "Within us",
        options: ["Within us", "Only in books", "Only in temples"]
      },
      {
        question: "What was Sri Ramakrishna’s childhood name?",
        correct: "Gadadhar",
        options: ["Gadadhar", "Narendra", "Hanuman"]
      }
    ],
    reflection:
